...
1. Run the v2 graph through a disposable AWS sandbox, including private endpoint access, add-on and capability readiness, AL2023 and Bottlerocket node joins, Access API, IRSA, Pod Identity, and destroy behavior.
